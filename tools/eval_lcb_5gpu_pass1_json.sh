#!/bin/bash
#
# 5卡 GPU 评估脚本 - LiveCodeBench v5 pass@1 (读取 JSON)
...
output_dir=${base_dir}/output/eval_results/${dataset}_${response_len_k}k_n${n_samples}_json
# 删除之前的结果
rm -rf ${output_dir}
mkdir -p ${output_dir}
...
experiment_name=DeepSeek-R1-Distill-Qwen-1.5B-pass1-json

echo "============================================================"
echo "LiveCodeBench v5 Evaluation - pass@${n_samples} (JSON input)"
echo "============================================================"
echo "Model: ${model_path}"
echo "Dataset: ${data_dir}/${dataset}.json (JSON format)"
